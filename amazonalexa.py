...
class AmazonAlexa(YomboModule):
    ...
    def _load_(self, **kwargs):
        ...
        try:
            ...
            self.authkey = yield self._AuthKeys.create(
                "Amazon Alexa",
        ...
        self.authkey.created_by = "alexa module"
        self.authkey.created_by_type = "module"
...
############################################
    ...
    def api_turn_on(self, request, device):
        try:
            request_id = device.turn_on(auth=self.authkey)
